...
public class Plip extends Creature {
    ...
    private double moveEngeryLoss = 0.15;
    private double stayEngeryGain = 0.2;
    private double energyThresh = 2;
    ...
    public Color color() {
        r = 99;
        b = 76;
        double intercp = ((255 - 63 ) * energy / energyThresh);
        g = 63 +  (int) intercp;
        return color(r, g, b);
    }
