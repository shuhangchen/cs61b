...
public class IntListTest {
    ...
    public void testInsertBack() {
        ...
        assertEquals(IntList.list(1), A.insertBack(1));
        assertEquals(IntList.list(1,2), A.insertBack(2));
        assertEquals(IntList.list(1,2,3), A.insertBack(3));
    }
    @Test
    public void testReverse() {
        ...
        assertEquals(nullIntList, IntList.reverse(nullIntList));
        assertEquals(IntList.list(2,1), IntList.reverse(B));
